...
@.str = private unnamed_addr constant [11 x i8] c"m=%d n=%d\0A\00", align 1
@.str.1 = private unnamed_addr constant [20 x i8] c"a=%d, b=%d, gcd=%d\0A\00", align 1
@.str.2 = private unnamed_addr constant [3 x i8] c"%d\00", align 1
@.str.1.3 = private unnamed_addr constant [3 x i8] c"%c\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %9 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([20 x i8], [20 x i8]* @.str.1, i64 0, i64 0), i32 %4, i32 %5, i32 %8)
  ret i32 0
}
...
define dso_local i32 @getch() #0 {
  %1 = alloca i8, align 1
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.3, i64 0, i64 0), i8* %1)
...
define dso_local void @putch(i32 %0) #0 {
  ...
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.3, i64 0, i64 0), i32 %3)
  ret void
}
...
define dso_local void @putarray(i32 %0, i32* %1) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.4, i64 0, i64 0), i32 %6)
