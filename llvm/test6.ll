...
define dso_local i32 @main() #0 {
  ...
  %4 = call i32 (...) bitcast (i32 ()* @getch to i32 (...)*)()
  store i32 %4, i32* %2, align 4
  %5 = call i32 (...) bitcast (i32 ()* @getch to i32 (...)*)()
  store i32 %5, i32* %3, align 4
  %6 = load i32, i32* %2, align 4
  %7 = call i32 (i32, ...) bitcast (void (i32)* @putch to i32 (i32, ...)*)(i32 %6)
  %8 = load i32, i32* %3, align 4
  %9 = call i32 (i32, ...) bitcast (void (i32)* @putch to i32 (i32, ...)*)(i32 %8)
  %10 = call i32 (i32, ...) bitcast (void (i32)* @putch to i32 (i32, ...)*)(i32 10)
  %11 = load i32, i32* %2, align 4
  %12 = sub nsw i32 %11, 16
  %13 = call i32 (i32, ...) bitcast (void (i32)* @putch to i32 (i32, ...)*)(i32 %12)
  %14 = load i32, i32* %3, align 4
  %15 = add nsw i32 %14, 6
  %16 = call i32 (i32, ...) bitcast (void (i32)* @putch to i32 (i32, ...)*)(i32 %15)
  ret i32 0
}
