...
@.str.1.9 = private unnamed_addr constant [3 x i8] c"%c\00", align 1
...
@.str.5.13 = private unnamed_addr constant [3 x i8] c"%s\00", align 1
...
define dso_local i32 @main() #0 {
  ...
  %22 = call i32 (...) bitcast (i32 ()* @getint to i32 (...)*)()
  store i32 %22, i32* @gvar, align 4
  %23 = call i32 (...) bitcast (i32 ()* @getint to i32 (...)*)()
...
define dso_local i32 @getint() #0 {
  %1 = alloca i32, align 4
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i32* %1)
...
define dso_local i32 @getch() #0 {
  %1 = alloca i8, align 1
  %2 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.9, i64 0, i64 0), i8* %1)
...
define dso_local i32 @getarray(i32* %0) #0 {
  ...
  %5 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i32* %3)
...
10:                                               ; preds = %6
  ...
  %15 = call i32 (i8*, ...) @__isoc99_scanf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i32* %14)
  br label %16
...
define dso_local void @putint(i32 %0) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.8, i64 0, i64 0), i32 %3)
  ret void
}
...
define dso_local void @putch(i32 %0) #0 {
  ...
  store i32 %0, i32* %2, align 4
  %3 = load i32, i32* %2, align 4
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.1.9, i64 0, i64 0), i32 %3)
  ret void
}
...
define dso_local void @putarray(i32 %0, i32* %1) #0 {
  ...
  %7 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.2.10, i64 0, i64 0), i32 %6)
...
12:                                               ; preds = %8
  ...
  %18 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([4 x i8], [4 x i8]* @.str.3.11, i64 0, i64 0), i32 %17)
  br label %19
...
22:                                               ; preds = %8
  %23 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([2 x i8], [2 x i8]* @.str.4.12, i64 0, i64 0))
  ret void
}
...
define dso_local void @putstr(i8* %0) #0 {
  ...
  %4 = call i32 (i8*, ...) @printf(i8* getelementptr inbounds ([3 x i8], [3 x i8]* @.str.5.13, i64 0, i64 0), i8* %3)
  ret void
}
