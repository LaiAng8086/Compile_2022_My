...
b0:
  ...
  %l3 = call i32 @func1(i32* %l2)
  %l4 = call i32 @func2([3 x i32]* %l1)
  %l5 = getelementptr [3 x i32], [3 x i32]* %l1, i32 1, i32 2
  %l6 = load i32, i32* %l5
  ret i32 %l6
}
...
b0:
  ...
  store i32 1, i32* %l3
  %l4 = getelementptr [3 x [3 x i32]], [3 x [3 x i32]]* %l1, i32 0, i32 0
  %l5 = call i32 @func2([3 x i32]* %l4)
  call void @putint(i32 %l5)
  %l6 = getelementptr [3 x [3 x i32]], [3 x [3 x i32]]* %l1, i32 0, i32 2, i32 0
  %l7 = call i32 @func1(i32* %l6)
